...
--1. Automatically Insert Next Temperature Reading
...
--2.  Create a procedure to insert random values for different sensor types
...
--3. Automatically Insert Next Temperature Reading
